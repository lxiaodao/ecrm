...
.login_logo img {height: 70px;width: 199px;}
...
<div class="main_box">
      ...
      <div class="login_msg">
        ...
        <div class="login_form">
    		...
    		<form action="<c:url value='login'/>" id="login_form" method="post">
    			...
    			<div class="form-group">
                    <label class="t"></label>
                    <label for="j_remember" class="m"><input id="j_remember" name="remember-me" type="checkbox" value="true">&nbsp;记住登陆账号!</label>
    			</div>
	...
	<div class="bottom">Copyright &copy; 2016 - 2020 <a href="http://www.billioncube.com" target="_blank">四川亿立方科技有限公司</a></div>
</div>
</body>
</html>